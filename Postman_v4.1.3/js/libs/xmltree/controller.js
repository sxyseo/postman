		...
		process: function(data) {
			if (typeof data == 'string') {
				try {
					...
					//Xml parsing error here
					$("div.xv-source-pane-inner").html("ERROR: Could not parse the response");
					$(".xv-outline").remove();
					data = null;
				}
			}
			...
			if (data) {
				//BUGFIX
				var tree = xv_renderer.render(data, xv_settings.getValue('init_depth', 100));
