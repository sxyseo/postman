...
var xv_renderer = (function() {
	...
	function stylizeElement(node, depth) {
		...
		result.push('<span class="xv-tag-open"><span class="xv-tag-openingBracket">&lt;</span>');
		result.push('<span class="xv-tag-name">' + node.nodeName +'</span>');
		if (attrs.length)
			result.push(' ' + attrs.join(' '));
			
		if (!node.childNodes.length) {
			result.push(' <span class="xv-tag-closingBracket">/&gt;</span></span></span>');
		} else {
			result.push('<span class="xv-tag-closingBracket">&gt;</span></span>');
			...
			result.push('<span class="xv-tag-close"><span class="xv-tag-openingBracket">&lt;/</span>' +
				'<span class="xv-tag-name">' + node.nodeName +'</span>' +
				'<span class="xv-tag-closingBracket">&gt;</span></span></span>');
		}
